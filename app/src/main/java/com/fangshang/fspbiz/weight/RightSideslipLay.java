...
import com.fangshang.fspbiz.weight.adapter.RightSideslipLayAdapter;
...
public class RightSideslipLay extends RelativeLayout {
    ...
    protected void initPopuptWindow(List<AttrList.Attr.Vals> mSelectData) {
        ...
        mMenuPop.showAtLocation(RightSideslipLay.this, Gravity.TOP, 100,  BarUtils.getStatusBarHeight());
