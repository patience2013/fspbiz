...
public class OneSortAdapter extends BaseQuickAdapter<HttpResponseStruct.Housebean,BaseViewHolder> {
    ...
    public OneSortAdapter(List<HttpResponseStruct.Housebean> data) {
...
//            String url = title.substring(0,10);
//            titles.append(url+"...");
//            helper.setText(R.id.tv_text,titles);
//        }else{
//
//        }
        helper.setText(R.id.tv_text,title);
