...
/**
 * Created by xiong on 2018/1/22/022 19:27
 */

public class HouseListActivity extends BaseBackActivity {
    ...
    protected void initView() {
        ...
        mRv_list = new RecyclerView(this);
        mRv_list.setBackgroundColor(this.getResources().getColor(R.color.main_bg));
...
//                    requestList();
    ...
    public void initAdapter() {
        View view = View.inflate(this,R.layout.line_head,null);
...
//        adapter.setEmptyView(R.layout.loading_view, (ViewGroup) mRv_list.getParent());
    ...
    private void initMenu() {
        ThreeSortHouseLinelayout sortLinelayout = new ThreeSortHouseLinelayout(this);
...
//                requestList();
        ...
        View view_status = LayoutInflater.from(this).inflate(R.layout.pop_filtrate, null);
