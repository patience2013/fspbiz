 ...
 * data：16/7/27
 */
public class GridVideoAdapter extends
        RecyclerView.Adapter<GridVideoAdapter.ViewHolder> {
    ...
    public GridVideoAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.gv_filter_video,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.icon_add_business_license);
