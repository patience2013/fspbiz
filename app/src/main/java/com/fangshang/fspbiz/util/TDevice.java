...
import com.fangshang.fspbiz.base.BaseApplication;
...
public class TDevice {
    ...
    public static boolean isPortrait() {
        return BaseApplication.getContext().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = BaseApplication.getContext().getResources().getConfiguration().screenLayout;
    ...
    public static int getVersionCode() {
        return getVersionCode(BaseApplication.getContext().getPackageName());
    }
...
//    }
    ...
    public static boolean hasWebView(Context context) {
        if (mHasWebView != null) {
            if (!mHasWebView)
                TsUtils.show("Not WebView for you phone");
            return mHasWebView;
        }
        try {
