...
import com.fangshang.fspbiz.BuildConfig;
import com.fangshang.fspbiz.MainActivity;
import com.fangshang.fspbiz.R;
import com.fangshang.fspbiz.util.StreamUtil;
...
public class DownloadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        final File apkFile = new File(saveFileName + "guanlouyi.apk");
        setUpNotification();
        new Thread() {
            @Override
            public void run() {
    ...
    private void installApk() {
        File file = new File(saveFileName + "guanlouyi.apk");
        if (!file.exists())
            return;
...
//            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), BuildConfig.APPLICATION_ID+".myprovider", file);
